...
public class RenderUtils {
     ...
     */
    protected static void drawGradientRect(int left, int top, int right, int bottom, int color, float startAlpha, float endAlpha) {
        ...
        tessellator.addVertex((double) left, (double) bottom, (double) 0);
        tessellator.addVertex((double) left, (double) top, (double) 0);
        tessellator.setColorRGBA_F(f1, f2, f3, endAlpha);
        tessellator.addVertex((double) right, (double) top, (double) 0);
        tessellator.addVertex((double) right, (double) bottom, (double) 0);
        tessellator.draw();
